...
<head>
    ...
    <title>Wie nutze ich das Ticket System? - PixelHide Docs</title>
...
<body>
    <aside>
        ...
        <a href="#" class="nav-link">Wie nutze ich das Ticket System?</a>
    </aside>
    ...
    <main>
        <section>
            <h1>Wie benutze ich das Ticket System?</h1>
            <p>Hier entsteht eine ultramoderne Doku-Seite mit gläsernem Design, sanften Übergängen und klarer Struktur. Alles ist aktuell noch Platzhaltertext.</p>
        </section>

        <section>
            <h2>Ticket Öffnung</h2>
            <p>Hier folgen bald Details zu einem Thema, mit eleganter Typografie und intuitivem Aufbau.</p>
        </section>

        <section>
            <h3>Unterkapitel</h3>
            <p>Noch mehr Platzhaltertext — modern, clean und leserfreundlich.</p>
        </section>
    </main>
